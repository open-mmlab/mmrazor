...
class RMSpropTF(Optimizer):
    ...
    before sqrt and a few other modifications to closer match Tensorflow for
    matching hyper-params.Noteworthy changes include:
    ...
    _.The centered version first appears in `Generating Sequences With
    ...
    Arguments:
        ...
        https://arxiv.org/abs/1711.05101 lr_in_momentum (bool, optional):
        learning rate scaling is included in the momentum buffer update as per
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                if group['momentum'] > 0:
                    ...
                    # Tensorflow accumulates the LR scaling in
                    # the momentum buffer
