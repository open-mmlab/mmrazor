...
seach_space_block_type_list_list = [
    [basic_blocks.SuperResIDWE1K3, basic_blocks.SuperResIDWE2K3, basic_blocks.SuperResIDWE4K3,
    basic_blocks.SuperResIDWE6K3,
    basic_blocks.SuperResIDWE1K5, basic_blocks.SuperResIDWE2K5, basic_blocks.SuperResIDWE4K5,
    basic_blocks.SuperResIDWE6K5,
    basic_blocks.SuperResIDWE1K7, basic_blocks.SuperResIDWE2K7, basic_blocks.SuperResIDWE4K7,
    basic_blocks.SuperResIDWE6K7],
]

__block_type_round_channels_base_dict__ = {
    basic_blocks.SuperResIDWE1K3: 8,
    basic_blocks.SuperResIDWE2K3: 8,
    basic_blocks.SuperResIDWE4K3: 8,
    basic_blocks.SuperResIDWE6K3: 8,
    basic_blocks.SuperResIDWE1K5: 8,
    basic_blocks.SuperResIDWE2K5: 8,
    basic_blocks.SuperResIDWE4K5: 8,
    basic_blocks.SuperResIDWE6K5: 8,
    basic_blocks.SuperResIDWE1K7: 8,
    basic_blocks.SuperResIDWE2K7: 8,
    basic_blocks.SuperResIDWE4K7: 8,
    basic_blocks.SuperResIDWE6K7: 8,
}
