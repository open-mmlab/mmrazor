...
class Autoformer(BaseAlgorithm):
    ...
    Args:
        architecture (Union[BaseModel, Dict]): The config of :class:`BaseModel`
            or built model. Corresponding to supernet in NAS algorithm.
        mutators (Optional[Union[BaseMutator, Dict]]): The dict of Mutators
            config. Defaults to None.
        fix_subnet (Optional[ValidFixMutable]): The path of yaml file or
