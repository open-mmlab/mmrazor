...
class Channel(BaseChannel):
    ...
    def __init__(self,
                 ...
                 out_related=True,
                 expand_ratio=1) -> None:
        super().__init__(name, module, index, node, out_related, expand_ratio)
    ...
    def init_from_base_channel(base_channel: BaseChannel):
        ...
        return Channel(
            ...
            base_channel.index,
            node=None,
            out_related=base_channel.output_related,
...
class ChannelGroup(BaseModule):
    ...
    def init_from_cfg(cls, model: nn.Module, config: Dict) -> 'ChannelGroup':
        ...
        def auto_fill_config(channel_config: Dict,
                             is_output_related: bool,
            ...
            if 'end' not in channel_config:
                channel_config['end'] = group_config['init_args'][
                    'num_channels']
            channel_config['is_output_related'] = is_output_related
