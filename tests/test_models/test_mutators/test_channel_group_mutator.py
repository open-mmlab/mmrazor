...
from mmrazor.models.mutators.channel_mutator import ChannelGroupMutator
...
class TestChannelGroupMutator(unittest.TestCase):
    ...
    def test_sample_subnet(self):
        ...
        for i, data in enumerate(data_models):
            with self.subTest(i=i, data=data):
                ...
                mutator = ChannelGroupMutator(model)
