...
from mmrazor.models.mutables import SequentialMutableChannelGroup


class TestSequentialMutableChannelGroup(TestCase):

    def test_num(self):
        group = SequentialMutableChannelGroup(48)
    ...
    def test_ratio(self):
        group = SequentialMutableChannelGroup(48, choice_mode='ratio')
        group.current_choice = 0.5
    ...
    def test_divisor(self):
        group = SequentialMutableChannelGroup(
    ...
    def test_config_template(self):
        ...
        group2 = SequentialMutableChannelGroup.init_from_cfg(None, config)
