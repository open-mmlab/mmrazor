...
class TestDynamicLayer(TestCase):
    ...
    def test_dynamic_conv(self):
        ...
        in_channels_cfg = dict(type='SquentialMutableChannel')

        out_channels_cfg = dict(type='SquentialMutableChannel')
    ...
    def test_dynamic_linear(self):
        ...
        in_features_cfg = dict(type='SquentialMutableChannel')

        out_features_cfg = dict(type='SquentialMutableChannel')
    ...
    def test_dynamic_batchnorm(self):
        ...
        num_features_cfg = dict(type='SquentialMutableChannel')
    ...
    def test_dynamic_groupnorm(self):
        ...
        num_channels_cfg = dict(type='SquentialMutableChannel')
