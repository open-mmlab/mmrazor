...
train_pipeline = [
    ...
    dict(type='ColorJitter', brightness=0.06, contrast=0.06, saturation=0.06),
...
custom_hooks = [dict(type='EMAHook', momentum=2e-5, priority='ABOVE_NORMAL')]
