...
_base_ = './group_fisehr_flops_prune_retinanet_r50_fpn_1x_coco.py'
pruned_path = 'https://download.openmmlab.com/mmrazor/v1/pruning/group_fisher/retinanet/flops/group_fisehr_flops_prune_retinanet_r50_fpn_1x_coco.pth'  # noqa
finetune_lr = 0.005
##############################################################################
