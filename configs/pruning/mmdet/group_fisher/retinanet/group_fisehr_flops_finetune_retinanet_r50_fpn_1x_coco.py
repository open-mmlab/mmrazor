...
_base_ = './group_fisehr_flops_retinanet_r50_fpn_1x_coco.py'  # config to prune your model

pruned_path = './work_dirs/group_fisehr_flops_retinanet_r50_fpn_1x_coco.py/flops_0.50.pth'  # path of the checkpoint of the pruned model.
##############################################################################
# yapf: enable
