if '_base_':
    from mmyolo.configs.rtmdet.rtmdet_tiny_syncbn_fast_8xb32_300e_coco import *

from mmrazor.models import (ChannelWiseDivergence, ConfigurableDistiller,
                            ConvModuleConnector, FpnTeacherDistill,
                            NormConnector)
